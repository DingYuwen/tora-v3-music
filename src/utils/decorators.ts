  ...
  return function songDecorator(constructor) {
    return class PlaySong extends constructor {
      UNSAFE_componentWillReceiveProps (nextProps) {
        ...
        return super.UNSAFE_componentWillReceiveProps && super.UNSAFE_componentWillReceiveProps()
      }

      UNSAFE_componentWillMount() {
        Taro.eventCenter.off('nextSong')
        return super.UNSAFE_componentWillMount && super.UNSAFE_componentWillMount()
      }
